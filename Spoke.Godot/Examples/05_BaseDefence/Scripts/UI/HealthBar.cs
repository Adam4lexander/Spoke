...
public partial class HealthBar : SpokeNode2D {
    ...
    readonly State<float> fraction = State.Create(1f);
    ...
    protected override void Init(EffectBuilder s) {
        ...
        var clamped = s.Memo(s => Mathf.Clamp(s.D(fraction), 0f, 1f));
    ...
    public override void _Draw() {
        ...
        DrawRect(new Rect2(origin, new Vector2(w * Mathf.Clamp(fraction.Now, 0f, 1f), h)), colour.Now);
    }
}
