...
public readonly struct HoverInfo : IEquatable<HoverInfo> {
    ...
    /// <summary>Text shown in the sidebar's message line.</summary>
    ...
    public bool Equals(HoverInfo other)
        => Description == other.Description && Coverage == other.Coverage && PowerNode == other.PowerNode;
    ...
    public static bool operator ==(HoverInfo a, HoverInfo b) => a.Equals(b);
    public static bool operator !=(HoverInfo a, HoverInfo b) => !a.Equals(b);
}
